        ...
        <div class="lg:flex lg:flex-row lg:items-stretch lg:-mx-2">
          ...
          <div class="lg:basis-1/2 mb-4">
            <div class="rounded-lg bg-blue-700 shadow-lg flex flex-col text-center px-5 py-10 md:mx-2 min-h-full">
              ...
              <div class="grow flex flex-col justify-center items-center">
                <p class="text-white font-bold text-lg"><span class="block text-6xl mb-2"><?php print floor(floatval(time() - 1675233000) / (24.0 * 60.0 * 60.0)); ?></span> achtereenvolgende dagen met 2 werkende WC's.</p>
              </div>
            </div>
          </div>
        </div>
